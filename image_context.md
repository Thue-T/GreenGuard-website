...
\f0\fs24 \cf0 # Image Context for GreenGuard Website\
\
All image assets and their descriptions for Codex.\
\
-------------------------------------------------------------------\
MISSION IMAGES (folder: assets/img/mission/)\
-------------------------------------------------------------------\
\
...
-------------------------------------------------------------------\
\
Benjamin-Tvorup-1.0.png\
Description: CTO & Co-Founder \'97 M.Sc. Mechanical Engineering\
\
Christian-Dragkilde-1.0.png\
Description: Lead Prototyping \'97 M.Sc. Mechanical Engineering, Member of DISCO\
\
Thomas-Bjerrum-1.0.png\
Description: CEO & Co-Founder \'97 M.Sc. Mechanical Engineering\
\
-------------------------------------------------------------------\
BRAND IMAGES (folder: assets/img/brand/)\
-------------------------------------------------------------------\
\
GGA_Logo.svg\
Vector logo \'97 primary version\
\
GGA_Logo-250.png\
PNG logo 250x250px \'97 used for favicon/tab icon\
\
GGA_Logo-500.png\
PNG logo 500x500px \'97 used on homepage navigation top-left\
\
-------------------------------------------------------------------\
